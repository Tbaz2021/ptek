<x-app-layout>
    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <main>
               ...
               <div style="width: 80%">
                <form class="form-horizontal" role="form" action="{{ route('tasks.update',$task) }}" method="POST">
                 @csrf
                 @method('PUT')
        ...
        <div class="form-group">
         ...
         border-danger
     @enderror" cols="30" rows="2">{{ $task->issue_c }}</textarea>
               <div class="text-danger text-sm">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                border-danger
            @enderror" cols="30" rows="2">{{ $task->action_taken }}</textarea>
               <div class="text-danger text-sm">
                  @error('action_taken')
                      {{ $message }}
                  @enderror
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
                ...
                border-danger
            @enderror" value="{{ $task->ticket_num }}">
             <div class="text-danger text-sm">
                @error('ticket_number')
                    {{ $message }}
                @enderror
   ...
   <div class="row">
    ...
    <button type="submit" class="btn btn-block btn-info col-md-5">Update</button>
   </div>
